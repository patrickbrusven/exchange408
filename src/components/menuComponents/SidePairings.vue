<template>
  <div class="container">
    <categorieComponent categorie="SIDE PAIRINGS"
                      description="" />
    <listComponent v-for="item in sidePairings"
                  :item="item"
  ...
  created() {
    this.sidePairings = [
      ...
      },
      {
        ...
        description: 'Baked penne, creamy cheddar',
        mealPrice: 4,
        price: '',
        pp: '',
        gf: false,
      ...
      // {
      //   title: 'Meats',
      //   description: 'We smoke all of our meat in-house for your taste buds enjoyment! Choices include Smoked Chicken, Smoked Pork Shoulder  $2.50, Pork Belly (bacon)  $3.50, Ribeye Steak $4.50',
      //   mealPrice: '',
      //   price: '',
      //   pp: '',
      //   gf: true,
      ...
      // },
      // {
      //   title: 'Meat, Smoked Chicken or Smoked Pork Shoulder',
      //   description: 'We smoke all of our meat in-house for your taste buds enjoyment!',
      //   mealPrice: '2.50',
      //   price: '',
      //   pp: '',
      //   gf: true,
